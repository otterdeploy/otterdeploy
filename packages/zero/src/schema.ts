...
import type * as drizzleSchema from "@otterdeploy/db/schema";
...
const deploymentTable = {
  ...
  columns: {
    ...
    buildMethod: {
      type: "string",
      optional: true,
      customType: null as unknown as "nixpacks" | "dockerfile" | "buildpack",
...
const secretProviderBindingTable = {
  ...
  columns: {
    ...
    status: {
      type: "string",
      optional: true,
      customType: null as unknown as "active" | "provisioning" | "error",
    },
    metadata: {
      type: "json",
      optional: true,
