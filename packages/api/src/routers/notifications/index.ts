...
export const notificationsRouter = {
  channels: {
    list: orgScopedProcedure.notifications.channels.list.handler(async ({ context }) => {
    ...
    }).notifications.channels.update.handler(async ({ input, context, errors }) => {
    ...
    }).notifications.channels.delete.handler(async ({ input, context, errors }) => {
      context.log.set({ target: { type: "notificationChannel", id: input.id } });
    ...
    }).notifications.channels.test.handler(async ({ input, context, errors }) => {
  ...
  subscriptions: {
    ...
    toggle: requirePermission({
      notificationChannel: ["update"],
    }).notifications.subscriptions.toggle.handler(async ({ input, context, errors }) => {
