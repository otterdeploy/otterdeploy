...
import { loadManifestFile, writeManifestFile } from "../manifest-file";

const addService = defineCommand({
  meta: { name: "service", description: "Add a service to otterstack.json" },
  args: {
...
export const addCommand = defineCommand({
  meta: { name: "add", description: "Append a resource to otterstack.json" },
  subCommands: {
    service: addService,
