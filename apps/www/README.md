...
Marketing landing page **and** documentation for Otterstack, served at
`otterstack.com` (landing) and `otterstack.com/docs` (docs).
...
```bash
bun dev:www          # via turbo + portless (www.otterstack)
# or, plain vite:
