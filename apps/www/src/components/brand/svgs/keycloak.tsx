...
/**
 * Keycloak mark (Simple Icons geometry). Simple Icons ships it in the gray
 * wordmark color #4D4D4D, which reads as disabled in the template gallery;
 * rendered instead in the official Keycloak product blue #008AAA.
 */
const Keycloak = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#008AAA">
