import type { Scene } from "./camera";
import type { CraftBasis } from "./craft";
import type { Spark } from "./field";

import { offscreen, project } from "./camera";
import { CRAFT_BANK, CRAFT_FOCAL, craftBasis, rotateCraft, TRAIL_ORIGIN } from "./craft";
import {
  CAM_HEIGHT,
  LIGHT,
  MAX_SPARKS,
...
export type { HeroLayout, Scene } from "./camera";
export { createScene, readSceneColors, resizeScene } from "./camera";
