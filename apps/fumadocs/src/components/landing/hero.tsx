...
function IsometricDiagram() {
  ...
  return (
    <div ref={ref} className="mt-20 overflow-x-hidden">
      <div className="relative mx-auto w-full max-w-[500px] h-[400px] max-[560px]:h-[280px]">
        <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[500px] h-[400px] max-[560px]:scale-[0.7] max-[560px]:origin-top">
        <div
