      ...
      <div className="card" style={{ padding: 18 }}>
        ...
        <div className="card" style={{ padding: 10, marginTop: 6, background: "var(--bg-sunken)" }}>
          <div className="mono" style={{ fontSize: 11, lineHeight: 1.8, color: "var(--fg-2)" }}>
            <div>
              1. <span style={{ color: "var(--info)" }}>setup</span> · alpine + corepack
            </div>
            <div>
              2. <span style={{ color: "var(--info)" }}>install</span> · pnpm install
              --frozen-lockfile
            </div>
            <div>
              3. <span style={{ color: "var(--info)" }}>build</span> · pnpm --filter ./apps/
              {service} build
            </div>
            <div>
      ...
      <div className="card" style={{ padding: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <Field label="Dockerfile path">
            <input className="input mono" defaultValue={`apps/${service}/Dockerfile`} />
          </Field>
      ...
      <div className="card" style={{ padding: 18 }}>
        <div className="row gap-2" style={{ marginBottom: 8 }}>
          ...
          <span className="badge">
            <I.warning width={9} height={9} /> deploys all services in compose.yml as a Docker Stack
          </span>
        </div>
        <Field label="Compose file">
          <input className="input mono" defaultValue="compose.yml" />
        </Field>
        <div style={{ height: 10 }} />
  ...
  return (
    <div className="card" style={{ padding: 18 }}>
      ...
      <Field label="Output directory">
        <input className="input mono" defaultValue="dist" />
      </Field>
    </div>
  );
}
