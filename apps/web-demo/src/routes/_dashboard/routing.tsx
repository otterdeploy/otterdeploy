...
import { WorkspaceRoutesTable, useWorkspaceRoutes } from "@/features/workspace-routing";
    ...
    <div className="grid gap-4 p-6">
      <div className="grid gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          All public domains across your projects. Global Caddy config (TLS issuer, redirects,
          wildcards) lands in Plan 6.
        </p>
      </div>
