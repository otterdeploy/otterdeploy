...
export function ResourceTasksTab({
  ...
  // Active = latest deployment that's actually serving traffic. If the
  // newest row is mid-roll (building) or just blew up (failed), prefer the
  // most recent RUNNING below it — that's the one currently answering
