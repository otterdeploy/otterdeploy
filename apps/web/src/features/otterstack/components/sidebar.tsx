...
const items: Array<{ id: Tab; label: string; icon: keyof typeof I; count?: number }> = [
...
export function Sidebar({ tab, setTab, env, setEnv }: Props) {
  return (
    <aside className="os-sidebar">
      <div className="os-side-section" style={{ paddingTop: 12 }}>
      ...
      <div className="os-side-section" style={{ paddingBottom: 8, paddingTop: 6 }}>
        <div
          style={{
            padding: "0 4px 6px",
            display: "flex",
