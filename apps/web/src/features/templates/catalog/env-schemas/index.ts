...
export const ENV_SCHEMAS: Record<string, TemplateEnvSchema> = {
  ...
  "grafana-prometheus": { source: grafana_prometheus, images: ["grafana/grafana", "prom/prometheus"] },
  ...
  immich: { source: immich, images: ["ghcr.io/immich-app/immich-server", "ghcr.io/immich-app/immich-machine-learning"] },
  ...
  jitsi: { source: jitsi, images: ["ghcr.io/jitsi/web", "ghcr.io/jitsi/prosody", "ghcr.io/jitsi/jicofo", "ghcr.io/jitsi/jvb"] },
  karakeep: { source: karakeep, images: ["ghcr.io/karakeep-app/karakeep", "ghcr.io/karakeep-app/karakeep-chrome"] },
  ...
  penpot: { source: penpot, images: ["penpotapp/frontend", "penpotapp/backend", "penpotapp/exporter"] },
