    ...
    <div className="flex flex-col gap-2">
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <MetricCard
          ...
          swatch={CPU_COLOR}
          value={
            agg.summary.latestCpuPct != null ? formatPercent(agg.summary.latestCpuPct, 1) : "–"
          }
          stats={
            aggHasData
              ? [
                  { label: "peak", value: formatPercent(agg.summary.cpuPeak, 1) },
                  { label: "avg", value: formatPercent(agg.summary.cpuAvg, 1) },
                  ...containerStat,
                ]
              : []
          }
