...
/**
 * Firebase flame (classic Simple Icons path, single-color). Brand amber
 * reads on both the light and dark canvas.
 */
const Firebase = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FFCA28">
