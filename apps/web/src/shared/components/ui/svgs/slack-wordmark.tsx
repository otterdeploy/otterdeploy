...
/**
 * Slack lockup (glyph + "slack" wordmark). The four-color glyph keeps its
 * brand fills; the wordmark text inherits `currentColor`, so it adapts to
 * light/dark automatically — no themed pair needed.
 */
