...
/**
 * Nextcloud mark (dashboard-icons). Colours are the brand's own.
 */
const Nextcloud = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 139.3 512.2 233.5" xmlns="http://www.w3.org/2000/svg">
