...
/**
 * Mailpit mark (dashboard-icons). Colours are the brand's own.
 */
const Mailpit = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 132.292 121.708" xmlns="http://www.w3.org/2000/svg">
    <title>Mailpit</title>
    <defs id="mailpit-defs10" />
    <path
