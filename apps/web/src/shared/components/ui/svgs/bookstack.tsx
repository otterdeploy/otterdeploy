...
/**
 * BookStack mark (dashboard-icons). Colours are the brand's own.
 */
const BookStack = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 230.397 218.62" xmlns="http://www.w3.org/2000/svg">
    <title>BookStack</title>
    <g fill="#fff" fillRule="evenodd" stroke="#0288d1" strokeLinejoin="round" strokeWidth="6">
