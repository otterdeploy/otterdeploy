...
/**
 * Uptime Kuma mark (Simple Icons). Rendered in the brand color #5CDD8B.
 */
const UptimeKuma = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#5CDD8B">
