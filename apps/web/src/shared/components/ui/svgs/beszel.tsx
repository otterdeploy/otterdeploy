...
/**
 * Beszel mark (dashboard-icons). Colours are the brand's own.
 */
const Beszel = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 56 70" xmlns="http://www.w3.org/2000/svg">
    <title>Beszel</title>
    <defs>
      <linearGradient id="beszel-gradient" x1="0%" y1="20%" x2="100%" y2="120%">
        <stop offset="0%" style={{ stopColor: "#747bff" }} />
        <stop offset="100%" style={{ stopColor: "#24eb5c" }} />
      </linearGradient>
    </defs>
    <path
      fill="url(#beszel-gradient)"
