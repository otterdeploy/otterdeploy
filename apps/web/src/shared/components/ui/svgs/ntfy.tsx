...
/**
 * ntfy mark (Simple Icons). Rendered in the brand color #317F6F.
 */
const Ntfy = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#317F6F">
    <title>ntfy</title>
