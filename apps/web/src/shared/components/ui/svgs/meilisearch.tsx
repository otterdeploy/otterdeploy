...
/**
 * Meilisearch mark (Simple Icons). Rendered in the brand color #FF5CAA.
 */
const Meilisearch = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FF5CAA">
