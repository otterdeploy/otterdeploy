...
/**
 * Buzz mark, dark variant (dashboard-icons). The upstream asset flips its ink
...
const BuzzDark = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 466 309" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect width="466" height="309" fill="#d7d72e" mask="url(#buzz-dark-bee)" />
  </svg>
);
