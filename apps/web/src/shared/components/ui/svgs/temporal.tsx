...
/**
 * Temporal mark (Simple Icons). The brand mark is monochrome (#000000), which disappears on the dark
 * canvas; rendered via currentColor so it inherits the tile's foreground
 * in both themes (same treatment as the GitHub mark).
 */
