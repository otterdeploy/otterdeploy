...
/**
 * Authentik mark (Simple Icons). Rendered in the brand color #FD4B2D.
 */
const Authentik = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FD4B2D">
