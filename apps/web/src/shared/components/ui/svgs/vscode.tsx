...
/**
 * Visual Studio Code mark (dashboard-icons). Colours are the brand's own.
 */
const VisualStudioCode = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="none">
    ...
    <g mask="url(#vscode-a)">
      ...
      <path
        fill="url(#vscode-d)"
        fillRule="evenodd"
        d="M70.851 99.317a6.22 6.22 0 0 0 4.96-.19L96.4 89.22a6.25 6.25 0 0 0 3.54-5.633V16.413a6.25 6.25 0 0 0-3.54-5.632L75.812.874a6.23 6.23 0 0 0-7.104 1.21L29.294 38.04 12.126 25.01a4.16 4.16 0 0 0-5.317.236l-5.507 5.009a4.17 4.17 0 0 0-.004 6.162L16.186 50 1.298 63.583a4.17 4.17 0 0 0 .004 6.162l5.507 5.009a4.16 4.16 0 0 0 5.317.236l17.168-13.03 39.414 35.958a6.2 6.2 0 0 0 2.143 1.4M74.954 27.3 45.048 50l29.906 22.701z"
        clipRule="evenodd"
        opacity=".25"
