...
/**
 * Autumn mark (useautumn/autumn). Colours are the brand's own.
 */
const Autumn = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} role="img" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" fill="none">
    <title>Autumn</title>
