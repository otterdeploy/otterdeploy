...
function RouteComponent() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(128,89,42,0.14),_transparent_28%),linear-gradient(180deg,_rgba(255,252,247,0.96),_rgba(250,247,241,1))] p-6">
