...
**Files:**
- Modify: `apps/web/src/routes/project/$projectId/index.tsx` (currently the Empty placeholder; replace with the real composition)
...
- [ ] **Step 1: Rewrite `apps/web/src/routes/project/$projectId/index.tsx`**
...
```bash
git add apps/web/src/routes/project/$projectId/index.tsx
